...
1. Usuario hace clic
2. **Input Binding** captura el evento
3. Envía valor via WebSocket →
4. ← Recibe datos via WebSocket
5. **Output Binding** actualiza DOM
:::
...
1. Recibe `input$x`
2. Ejecuta lógica reactiva
3. Genera `output$y`
4. Envía resultado al navegador
:::
:::
